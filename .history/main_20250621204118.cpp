...
int main()
{
...

    {
        ...
        case 0:
            /* code */
            random_walker.move(sf::Vector2f(0.1f, 0.1f));
        case 1:
            random_walker.move(sf::Vector2f(0.1f, 0.0f));
        case 2:
            random_walker.move(sf::Vector2f(-0.1f, -1.0f));
        case 3:
            random_walker.move(sf::Vector2f(-1.0f, 0.0f));
        default:
            break;
        }
