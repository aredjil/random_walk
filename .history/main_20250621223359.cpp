...
// Get a random state (up, right, down, left)
inline int get_direction();

int main()
{
    const float step{1.0f}; // Step size
    ...
    // Loading the font
    sf::Font font; // Loading the font to viuslize the current step of the simulation 
