...
This code contains a simple 2D lattice random walk. An element starts at the center of window, and with uniform probability it can jump by a unit step to any of the four neighboring states. I have used Once the random walker hits the boundaries of the window, it continues from the other side. 
