...
int main()
{
...

    {
        ...
        switch (next_state)
        {
        case 0: position.y -= step; break; // up
        case 1: position.x += step; break; // right
        case 2: position.y += step; break; // down
        case 3: position.x -= step; break; // left
        }
